...
USD figures mix two rate cards: Anthropic's for Opus 5 / Sonnet 5, OpenAI's gpt-5.6-sol standard short-context rates for the gpt56sol runs (see pricing.py for the tier assumptions). Reference costs for comparison, not charges incurred.
